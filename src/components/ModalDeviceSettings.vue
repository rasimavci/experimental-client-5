<template>
  <div class="modal-mask" v-if="deviceSettingsModal">
    <div class="modal-container">
      ...
      <div class="keypad">
        <button class="button glyphicon glyphicon-send" @click="makeCall(participant,'message')">
        </button>
...
export default {
  ...
  computed: {
    ...mapGetters(['deviceSettingsModal'])
  },
  methods: {
        ...mapActions(['send']),
    make () {
